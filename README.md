...
Модульный пакет ROS 2 для обнаружения препятствий на основе LiDAR в реальном времени и **планирования пути A\***, разработанный для больших БПЛА с фиксированным крылом/VTOL (размах крыла 15 футов). Реализация протестирована в симуляции и готова к работе на оборудовании.
...
- Настроено для БПЛА с размахом крыла 4,572 метра и опасной дистанцией 80 м
...
**Характеристики БПЛА:**
- Размах крыла: 15 футов/4,572 метра
- Длина: 14,5 футов/4,42 м
- Высота: 4 фута/1,22 м
